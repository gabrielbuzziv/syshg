...
<div class="wrapper" style="min-width: 320px;background-color: #fff;" lang="x-wrapper">
    <div class="preheader" style="Margin: 0 auto;max-width: 560px;min-width: 280px; width: 280px;width: calc(28000% - 173040px);">
        <div style="border-collapse: collapse;display: table;width: 100%;">
            ...
            <div class="snippet" style='Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #0f50d1;font-family: "Open Sans",sans-serif;'>

            </div>
            <!--[if (mso)|(IE)]></td><td style="width: 280px" valign="top"><![endif]-->
            <div class="webversion" style='Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 10px 0 5px 0;text-align: right;color: #0f50d1;font-family: "Open Sans",sans-serif;'>
    ...
    <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);" id="emb-email-header-container">
        ...
        <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
            <div class="logo-center" style="font-size:0px !important;line-height:0 !important;" align="center" id="emb-email-header"><img style="height: auto;width: 100%;border: 0;max-width: 116px;" src="{{ url('/uploads/empresas') }}/{{ $orcamento->empresa->logo }}" alt="" width="116" /></div>
        </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
    </div>
    <div style="background-color: #7f8c8d;">
        <div class="layout one-col" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
            <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0"><tr class="layout-full-width" style="background-color: #7f8c8d;"><td class="layout__edges">&nbsp;</td><td style="width: 600px" class="w560"><![endif]-->
                <div class="column" style='max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);text-align: left;color: #656873;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;'>
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;">
                        <p class="size-30" style="Margin-top: 0;Margin-bottom: 20px;font-family: open sans,sans-serif;font-size: 26px;line-height: 34px;" lang="x-size-30"><span class="font-open-sans"><span style="color:#ecf0f1"><strong>OR&#199;AMENTO</strong></span></span></p>
                    </div>
    ...
    <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" emb-background-style>
            ...
            <div class="column" style='text-align: left;color: #656873;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>

                <div style="Margin-left: 20px;Margin-right: 20px;">
                    <p class="size-18" style="Margin-top: 0;Margin-bottom: 0;font-family: open sans,sans-serif;font-size: 17px;line-height: 26px;" lang="x-size-18"><span class="font-open-sans"><span style="color:#7f8c8d">Ol&#225;, {{ $data->nome }}</span></span></p><p class="size-18" style="Margin-top: 20px;Margin-bottom: 20px;font-family: open sans,sans-serif;font-size: 17px;line-height: 26px;" lang="x-size-18"><span class="font-open-sans"><span style="color:#7f8c8d">Disponibilizamos um Or&#231;amento para voc&#234;, para visualizar clique no bot&#227;o abaixo.</span></span></p>
                </div>
            ...
            <div class="column" style='text-align: left;color: #656873;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div class="btn fullwidth btn--shadow btn--large" style="Margin-bottom: 20px;text-align: center;">
                        <![if !mso]><a style='border-radius: 4px;display: block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px 13px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #fff;box-shadow: inset 0 -2px 0 0 rgba(0, 0, 0, 0.2);background-color: #2980b9; font-family: &#39;Open Sans&#39;, sans-serif;font-family: "Open Sans",sans-serif;' href="{{ action('OrcamentoController@imprimir', base64_encode($orcamento->id))  }}">ACESSAR OR&#199;AMENTO</a><![endif]>
                        <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="{{ action('OrcamentoController@imprimir', base64_encode($orcamento->id)) }}" style="width:560px" arcsize="9%" fillcolor="#2980B9" stroke="f"><v:shadow on="t" color="#216694" offset="0,2px"></v:shadow><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,10px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">ACESSAR OR&#199;AMENTO</center></v:textbox></v:roundrect><![endif]--></div>
                </div>
    ...
    <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" emb-background-style>
            ...
            <div class="column" style='text-align: left;color: #656873;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
                    <p class="size-18" style="Margin-top: 0;Margin-bottom: 0;font-family: open sans,sans-serif;font-size: 17px;line-height: 26px;" lang="x-size-18"><span class="font-open-sans"><span style="color:#7f8c8d">Atenciosamente,</span></span></p><p class="size-18" style="Margin-top: 20px;Margin-bottom: 20px;font-family: open sans,sans-serif;font-size: 17px;line-height: 26px;" lang="x-size-18"><span class="font-open-sans"><span style="color:#7f8c8d">{{ $orcamento->empresa->nome }}</span></span></p>
                </div>
    ...
    <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" emb-background-style>
            ...
            <div class="column" style='text-align: left;color: #656873;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
                    <p class="size-12" style="Margin-top: 0;Margin-bottom: 0;font-size: 12px;line-height: 19px;" lang="x-size-12">Servi&#231;os T&#233;cnicos HG Diesel<br />
                        {{ $orcamento->empresa->rua }}, {{ $orcamento->empresa->numero }} - {{ $orcamento->empresa->bairro }}<br />
                        {{ $orcamento->empresa->cep }} - {{ $orcamento->empresa->cep }} - {{ $orcamento->empresa->estado }}<br />
                        <br />
                        Telefone:&nbsp;{{ $orcamento->empresa->telefone }}<br />
                        &#8203;E-mail&nbsp;{{ $orcamento->empresa->email }}</p>
                </div>
